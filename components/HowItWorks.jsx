...
const HowItWorks = () => {
  return (
    <section className="py-20 p-8 cursor-default">
      <div className="text-center mb-16">
        <h2 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-yellow-500 to-red-500">
          How It Works
        </h2>
        <p className="text-gray-700 mt-4 max-w-2xl mx-auto text-lg font-mono">
